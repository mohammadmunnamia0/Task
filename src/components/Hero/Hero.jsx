      ...
      >
        ...
        <div className="relative text-white max-w-lg lg:ml-[112px]">
            <div className="flex relative">
                <img src="/src/assets/HeroAvatar/Avatar.png" alt="" className="rounded-full " />
                <img src="/src/assets/HeroAvatar/Avatar (1).png" alt="" className="rounded-full absolute ml-8" />
                <img src="/src/assets/HeroAvatar/Avatar (2).png" alt="" className="rounded-full absolute ml-16" />
